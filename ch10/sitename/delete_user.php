...
if ( (isset($_GET['id'])) && (is_numeric($_GET['id'])) ) { // From view_users.php
	...
	echo '<h1>Delete a User</h1>'; # 1c. Include h1 since the code has moved down
...
if (mysqli_num_rows($r) == 1) { // Valid user ID, show the form.
	...
	$page_title = 'Delete a User - ' . $row[0]; // Show the user's information in the browser window's title bar
} else {
$page_title = 'Delete a User';
}
include('includes/header.html');
