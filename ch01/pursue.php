...
<body>
    ...
    # 6. Create a new script, from scratch, that defines, manipulates, and displays the values of some numeric variables.
    $student_age = 15;
    $graduation_age = 18;
